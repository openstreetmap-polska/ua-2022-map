export default {
    ...
    sources: {
        osmTiles: {
            ...
            attribution:
                'data © <a target="_top" rel="noopener" href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors.',
        },
        osmTilesUk: {
            type: 'raster',
            tiles: ['https://dopomoha.pl/hot/{z}/{x}/{y}.png'],
            tileSize: 256,
            maxzoom: 19,
            paint: { 'raster-fade-duration': 100 },
            attribution:
        ...
        mediaWikiTiles: {
            ...
            paint: { 'raster-fade-duration': 100 },
            attribution:
                'map: <a target="_top" rel="noopener" href="https://foundation.wikimedia.org/wiki/Maps_Terms_of_Use">WikiMedia</a>; data: © <a target="_top" rel="noopener" href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors.',
        },
        osmData: {
            type: 'geojson',
    ...
    layers: [
        ...
        },
        {
            ...
            filter: [
                'all',
                ['==', ['get', 'social_facility'], 'outreach'],
                ['==', ['get', 'social_facility:for'], 'refugee'],
            ],
            layout: {
                visibility: 'visible',
            },
        ...
        },
        {
            ...
            source: 'osmData',
            filter: ['==', ['get', 'information:for'], 'refugee'],
            layout: {
                visibility: 'visible',
            },
            paint: {
        ...
        },
        {
            ...
            filter: [
                'any',
                ['==', ['get', 'social_facility'], 'food_bank'],
                ['==', ['get', 'social_facility'], 'soup_kitchen'],
            ],
            layout: {
                visibility: 'visible',
            },
